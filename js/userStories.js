...
var userStories = [
  {
    ...
    body: `As a developer, I need my site to use valid and semantic markup, so that employers will love me.
  ...
  },
  {
    ...
    body:`As a developer, I want my site to use valid and semantic markup, so that employers will love me.
...
As a reader, I want the portfolio to use a nice color scheme, so that it stands out visually.`
  },
  {
    ...
    // authorUrl:   'http://www.imdb.com/name/nm0000102/',
    publishedOn: '2017-1-7',
    body:`As a developer, I want to use Handlebars for my project template, so that I can include new projects more easily.
